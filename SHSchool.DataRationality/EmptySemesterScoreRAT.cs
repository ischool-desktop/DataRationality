...
namespace SHSchool.DataRationality
{
    ...
    {
        List<SHSemesterScoreRecord> CorrectableRecs= new List<SHSemesterScoreRecord>();
        ...
        public string Description
        {
            get
            {
                ...
                strBuilder.AppendLine("檢查範圍：所有學生的學期科目成績。");
                strBuilder.AppendLine("檢查項目：檢查學生的學期科目成績是否為空值。");
                strBuilder.AppendLine("檢查意義：找出學生的學期科目成績是否為空值，若有找出並修正有空值的資料。");
