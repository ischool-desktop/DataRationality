...
{
    public class GradeYear1StudentAttendanceSummaryRAT : AbstractAttendanceSummaryRAT
    {
        public override string Name
        {
            get { return "學生（一年級）缺曠統計值檢查"; }
        }
        ...
        public override List<string> StudentIDs
        {
            get
            {
                return K12.Data.Student.SelectAll().Where(x=>x.Class!=null && x.Class.GradeYear.HasValue && x.Class.GradeYear.Value==1).Select(x => x.ID).ToList();
            }
        }
        ...
        public override string Description
        {
            get
            {
                ...
                strBuilder.AppendLine("1.一年級學生的日常生活表現紀錄。");
